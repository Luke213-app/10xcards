...
- [x] 3.1 Linting passes: `npm run lint` — e6da6b7
- [x] 3.2 Production build succeeds: `npm run build` — e6da6b7
...
- [x] 4.1 Linting passes: `npm run lint` — 064c96c
- [x] 4.2 Production build succeeds: `npm run build` — 064c96c
...
- [x] 5.1 Linting passes: `npm run lint` — 706b216
- [x] 5.2 Production build succeeds: `npm run build` — 706b216
